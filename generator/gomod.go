...
func (g *Generator) gen_gomod() ([]byte, error) {
	...
	mdf.AddNewRequire("github.com/smartcontractkit/anchor-go", "v0.3.2", false)
	...
	// add replacement for "github.com/smartcontractkit/anchor-go/errors" to ../../demo-anchor-go/errors
	// mdf.AddReplace("github.com/smartcontractkit/anchor-go", "", "../../demo-anchor-go", "")
	mdf.Cleanup()
